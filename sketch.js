...
var options = {
  ...
  p = Bodies.circle(50,200,20,options);
  World.add(world,p);
  ...
  //creating another set of blocks
  ...
  block24 = new Block(740,165,30,40);


  
 block25 = new Block(700,130,30,40);
   block26 = new Block(730,130,30,40);
   block27 = new Block(720,100,30,40);
  // block28 = new Block(770,150,30,40);

  slingShot = new Slingshot(this.p,{x:100,y:100});
...
function draw() {
  ...
  imageMode(CENTER)
  image( polygon_img,p.position.x,p.position.y,40,40);
...
function mouseReleased(){
    //Matter.Body.applyForce(this.p,p.position,{x:30,y:20});
